"""
Script para crear Stored Procedures en Supabase
Ejecutar: python backend/setup_stored_procedures.py
"""
import sys
import os
...
def setup_stored_procedures():
	"""Crea los stored procedures en Supabase"""
	...
	print("🔧 Creando Stored Procedures en Supabase...\n")

	for proc_name, proc_sql in procedures:
		try:
			print(f"⏳ Creando {proc_name}...")
			# Ejecutar el SQL directamente usando la librería de Supabase
			result = supabase.postgrest.raw(proc_sql)
